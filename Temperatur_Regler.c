...
UINT8 Temperatur_Regler_PI (UINT32 Regler_Sollwert, INT32 Regler_Temperatur_aktuell){
	...
	// Regelabweichung Ausummieren fuer I-Anteil (Integration)
	...
	// Berechnen der neuen Stellgroesse nach PI-Regler
	Stellgroesse = KP*Regelabweichung_e + KI*Summe_Regelabweichung;	// Reglergleichung fuer PI
